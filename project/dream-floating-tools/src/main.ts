...
import { faThumbTack, faWindowClose, faWindowMaximize, faWindowMinimize } from '@fortawesome/free-solid-svg-icons'
...
// 添加font-awesome图标
library.add(faThumbTack, faWindowMinimize, faWindowMaximize, faWindowClose)
